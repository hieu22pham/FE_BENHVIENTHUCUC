...
import "@fortawesome/fontawesome-free-webfonts/css/fa-solid.css"; // Nếu bạn chỉ muốn sử dụng biểu tượng solid
...
const withRouterInnerRef = (WrappedComponent) => {
    ...
    return React.forwardRef((props, ref) => {
        return <ComponentWithRef {...props} forwardRef={ref} />; //cũng chính là forwardRef InnerComponentWithRef trên nhận vào từ props
    });
};
